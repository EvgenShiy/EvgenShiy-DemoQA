...
* **[Allure TestOps](https://qameta.io/)**: тест-менджмент система для организации хранения авто- и ручных тестов в едином пространстве, с возможностью кастамизировать запуски.
...
#### 1. **Account**
1. **Pегистрации нового пользователя**.
...
<img src="assets/images/main.png" style="width:100%;" alt="Сборка в Jenkins">
---
...
<p align="center">
<img src="assets/images/Jira_main.png" alt="Jira main task">
</p>

Jira позволяет эффективно управлять багами, выявленными автотестами, отслеживать их жизненный цикл и фиксировать прогресс исправлений. Интеграция автотестов с Jira улучшает качество продукта и прозрачность процессов тестирования. 

<p align="center">
<img src="assets/images/Jira_main.png" alt="Jira bug task">
</p>
