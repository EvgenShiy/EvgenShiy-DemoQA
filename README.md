...
В проекте реализованы тесты для проверки различных аспектов функциональности сайта [demoqa.com](https://demoqa.com/). Тесты делятся на два типа: автотесты - реализованы для **UI** и **API**, и ручные тесты.
